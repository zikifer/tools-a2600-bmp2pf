...
public class AsymmetricalRepeatPlayfieldGenerator extends AsymmetricalPlayfieldGenerator {

    public AsymmetricalRepeatPlayfieldGenerator(PlayfieldGeneratorBuilder builder) {
        super(builder);
    }
